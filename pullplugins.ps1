...
Invoke-WebRequest -uri azureruncmd/wfplugins-azureruncommand-1.0.jar -Outfile c:\progra~1\embotics\vcommander\tomcat\wfplugins\azureruncmd/wfplugins-azureruncommand-1.0.jar
